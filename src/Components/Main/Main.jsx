            ...
            <section className="offer__list-item">
              <a href="#" className="cards">
                <div className="cards card1">
                  <img src={Playlist1} alt="icone" />
                  <span>Boas festas</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card2">
                  <img src={Playlist2} alt="icone" />
                  <span>Feitos para você</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card3">
                  <img src={Playlist3} alt="icone" />
                  <span>Lançamentos</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card4">
                  <img src={Playlist4} alt="icone" />
                  <span>Creators</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card5">
                  <img src={Playlist5} alt="icone" />
                  <span>Para treinar</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card6">
                  <img src={Playlist6} alt="icone" />
                  <span>Podcasts</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card7">
                  <img src={Playlist7} alt="icone" />
                  <span>Sertanejo</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card8">
                  <img src={Playlist8} alt="icone" />
                  <span>Samba e pagode</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card9">
                  <img src={Playlist9} alt="icone" />
                  <span>Funk</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card10">
                  <img src={Playlist10} alt="icone" />
                  <span>MPB</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card11">
                  <img src={Playlist11} alt="icone" />
                  <span>Rock</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card12">
                  <img src={Playlist12} alt="icone" />
                  <span>Hip Hop</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card13">
                  <img src={Playlist13} alt="icone" />
                  <span>Indie</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card14">
                  <img src={Playlist14} alt="icone" />
                  <span>Relax</span>
                </div>
              </a>
              <a href="#" className="cards">
                <div className="cards card15">
                  <img src={Playlist15} alt="icone" />
        ...
        <div className="grid-container">
          <div className="artist-card" id="">
            <div className="card-img">
              <img id="artist-img" className="artist-img" alt="icone" />
              <div className="play">
